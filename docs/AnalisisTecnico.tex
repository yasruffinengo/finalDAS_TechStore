...
\texttt{RepositorioVenta}. \\
Vista &
Formularios Windows Forms. &
\texttt{frmVenta}, \texttt{frmProducto}, \texttt{frmReporteVenta}. \\
Controlador &
Clases que reciben las solicitudes de la Vista y coordinan reglas y
repositorios. &
\texttt{ControladoraVenta}, \texttt{ControladoraProducto},
\texttt{ControladoraReporte}. \\
\bottomrule
\end{tabularx}
\end{table}

Por ejemplo, \texttt{frmVenta} captura la selección del cliente, sucursal,
vendedor, método de pago y productos; construye una solicitud representada por
\texttt{Venta}; luego invoca a \texttt{ControladoraVenta}. La controladora
valida y calcula los importes y, finalmente, delega la persistencia a
\texttt{RepositorioVenta}.
